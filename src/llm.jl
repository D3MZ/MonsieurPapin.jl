                ...
                "schema" => Dict(
                    ...
                    "properties" => Dict(
                        "keywords" => Dict(
                            ...
                            # blows past any timeout. The prompt asks for 30 concepts x the target
                            # languages (~300 elements for 10 languages); 350 trims the runaway
                            # tail with headroom, without reintroducing a max_tokens cap.
